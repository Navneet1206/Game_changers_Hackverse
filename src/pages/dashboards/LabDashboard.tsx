...
const DoctorDashboard = () => {
  ...
  const mockData = {
    appointments: [
      { id: '1', patient: 'Rahul Sharma', time: '10:00 AM', type: 'General Checkup' },
      { id: '2', patient: 'Priya Patel', time: '11:00 AM', type: 'Diabetes Consultation' },
      { id: '3', patient: 'Anjali Gupta', time: '1:00 PM', type: 'Pregnancy Follow-up' },
    ],
    patientCount: 120,
    pendingReports: 5,
    averageWaitTime: 20, // in minutes
  };
